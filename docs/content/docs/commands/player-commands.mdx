...
| `2h` | Hours | 2 hours |
| `1d` | Days | 1 day |
| `permanent` | Never expires | Until server restart |

**Examples:**
```
/showcase item Steve 30s
/showcase inventory @a 2h "My base supplies"
/showcase stats Alex 1d
```
...
- [Admin Commands](/commands/admin-commands) - Administrative commands
- [Chat Keywords](/features/chat-keywords) - Quick sharing shortcuts
- [Permissions](/configuration/permissions) - Detailed permission setup
- [Configuration](/configuration/config-file) - Customize command behavior