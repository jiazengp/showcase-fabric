...
See the complete [Installation Guide](/getting-started/installation) for detailed instructions.
...
Check the [Troubleshooting Guide](/support/troubleshooting) for detailed solutions.
...
See the [Permissions Guide](/configuration/permissions) for complete details.
...
See the [Configuration Guide](/configuration/config-file) for item icon setup details.

### Can I integrate with external services?

**Yes**, through the [Developer API](/developers/api-overview):
...
See the [Java API Guide](/developers/java-api) for development setup.
...
- [Configuration](/configuration/config-file) - Detailed configuration options
- [Commands Reference](/commands/player-commands) - All available commands
- [Troubleshooting](/support/troubleshooting) - Detailed problem solving