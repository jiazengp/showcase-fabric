...
- [PlaceholderAPI](/docs/developers/placeholderapi) - Placeholder integration details
- [Events Reference](/docs/developers/events) - Complete event documentation
- [Java API](/docs/developers/java-api) - Direct API integration
- [Configuration](/docs/configuration/config-file) - Configuration options